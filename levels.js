...
var loadLevels = function()
{
    ...
    g.lvlStart.field[l][8][3] = {gObject : "oneWay", objType : "up"};   
    g.lvlStart.field[l][9][4] = {gObject : "oneWay", objType : "left"}; 
    g.lvlStart.field[l][10][5] = {gObject : "oneWay", objType : "right"};
    g.lvlStart.field[l][11][6] = {gObject : "oneWay", objType : "down"};
